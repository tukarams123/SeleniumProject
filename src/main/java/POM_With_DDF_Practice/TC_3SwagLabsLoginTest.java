...
public class TC_3SwagLabsLoginTest {
	...
	public static void main(String[] args) throws InterruptedException, EncryptedDocumentException, IOException,FileNotFoundException {
		...
		Thread.sleep(1000);
		home.clickSwagLabsHomePageYourCart();
		Thread.sleep(1000);				

		SwagLabsYourCartPage cart=new SwagLabsYourCartPage(d);
		cart.verifySwagLabsYourCartPageProductName(sh.getRow(0).getCell(4).getStringCellValue());
		d.navigate().back();
		Thread.sleep(1000);	
